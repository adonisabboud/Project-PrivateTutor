...
class Teacher:
    ...
    Attributes:
        ...
        subjects_to_teach (Union[Unset, List[str]]):
    ...
    subjects_to_teach: Union[Unset, List[str]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        subjects_to_teach: Union[Unset, List[str]] = UNSET
        if not isinstance(self.subjects_to_teach, Unset):
            subjects_to_teach = self.subjects_to_teach
        ...
        if subjects_to_teach is not UNSET:
            field_dict["subjects_to_teach"] = subjects_to_teach
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subjects_to_teach = cast(List[str], d.pop("subjects_to_teach", UNSET))
        ...
        teacher.additional_properties = d
        return teacher
