...
class TestTeacherDbOperations(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if self.inserted_id:
            self.collection.delete_one({"_id": ObjectId(self.inserted_id)})
    ...
    def test_get_teacher(self):
        ...
        retrieved_teacher = get_teacher_from_mongo(self.collection_name, str(self.inserted_id))
    ...
    def test_update_teacher(self):
        ...
        update_result = update_teacher_in_mongo(self.collection_name, str(self.inserted_id), {"hourly_rate": updated_hourly_rate})
        ...
        # Verify the update
        updated_teacher = get_teacher_from_mongo(self.collection_name, str(self.inserted_id))
    ...
    def test_delete_teacher(self):
        # Delete the teacher
        delete_result = delete_teacher_from_mongo(self.collection_name, str(self.inserted_id))
        ...
        # Verify deletion
        deleted_teacher = get_teacher_from_mongo(self.collection_name, str(self.inserted_id))
